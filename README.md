...
<p align="center">
  <i>Современное, надежное и полностью нативное Android-приложение для безопасного локального хранения личных документов и важных данных. Проект разработан на актуальном стеке технологий с акцентом на абсолютную приватность, отзывчивый интерфейс и каноны Material You Expressive.</i>
</p>
...
* **🗂 Гибкое управление контентом:**
  * Cоздание пользовательских папок.
  * Добавление эмодзи-тегов к каждому документу.
...
* **🌈 Персонализация:** поддержка светлой, темной и системной тем оформления, а также динамических цветов **Material You Expressive**.
...
### 1. Главный экран
Отображает интерактивную ленту созданных папок и сетку документов внутри них. Здесь пользователя встречает анимированный маскот приложения. Карточки документов покрыты текстурой защитной сетки (гильош). Каждому документу можно присвоить эмодзи-тег.
...
<p align="center">
  <img src="./screenshots/main_screen.png" width="220" alt="Главный экран" style="margin: 10px;"/>
  <img src="./screenshots/detail_screen.png" width="220" alt="Просмотр документа" style="margin: 10px;"/>
</p>
<p align="center">
  <img src="./screenshots/search_screen.png" width="220" alt="Экран поиска" style="margin: 10px;"/>
  <img src="./screenshots/settings_screen.png" width="220" alt="Экран настроек" style="margin: 10px;"/>
</p>

---

## 📱 Экраны приложения (планшет/fold)
Интерфейс был полностью адаптирован под большие экраны планшетов и раскладушек типа Fold.

<p align="center">
  <img src="./screenshots/main_screen_fold.png" width="400" alt="Главный экран" style="margin: 10px;"/>
  <img src="./screenshots/detail_screen_fold.png" width="400" alt="Просмотр документа" style="margin: 10px;"/>
</p>
<p align="center">
  <img src="./screenshots/search_screen_fold.png" width="400" alt="Экран поиска" style="margin: 10px;"/>
  <img src="./screenshots/settings_screen_fold.png" width="400" alt="Экран настроек" style="margin: 10px;"/>
</p>
...
Приложение также доступно на RuStore (Если разбогатею, то опубликую в Google Play): 
https://www.rustore.ru/catalog/app/com.whitewolf.documents
