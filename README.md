...
<p align="center">
  <i>Современное, надежное и полностью нативное Android-приложение для безопасного локального хранения личных документов и важных данных. Проект разработан на актуальном стеке технологий с акцентом на абсолютную приватность, отзывчивый интерфейс и каноны Material Design 3.</i>
</p>
...
Приложение также доступно на RuStore (Если разбогатею, то опубликую в Google Play): https://www.rustore.ru/catalog/app/com.whitewolf.documents
